package com.example.debeziumwithmysql.listener;

import com.example.debeziumwithmysql.feature.UserServiceImpl;
...
public class DebeziumListener {
    ...
    public DebeziumListener(Configuration customerConnectorConfiguration, UserServiceImpl userServiceImpl) {
...
//         We're only interested in CREATE operation which are triggered upon new insert registry
            if(operation != Operation.READ) {
                ...
                userServiceImpl.replicateData(payload, operation);
